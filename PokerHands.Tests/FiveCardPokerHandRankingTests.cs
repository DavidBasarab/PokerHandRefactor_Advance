...
namespace PokerHands.Tests
{
    ...
    public class FiveCardPokerHandRankingTests
    {
        private FiveCardPokerHandRanking _fiveCardPokerHandRanking;

        [SetUp]
        public void SetUp()
        {
            _fiveCardPokerHandRanking = new FiveCardPokerHandRanking();
        }
        ...
        {
            var winner = _fiveCardPokerHandRanking.RankHands(hand1, hand2);
